...
export const ROLE_ACCOUNTS_ADMIN = "ROLE_ACCOUNTS_ADMIN";
export const ROLE_ACCOUNTS_USER = "ROLE_ACCOUNTS_USER";
export const ROLE_ACCOUNTS_HEAD = "ROLE_ACCOUNTS_HEAD";
export const ROLE_PLANNER = "ROLE_PLANNER";
...
export const ACCOUNTING_ACCESS_ROLES = [
    ...ADMIN_ROLES,
    ROLE_ACCOUNTS_ADMIN,
    ROLE_ACCOUNTS_USER,
    ROLE_ACCOUNTS_HEAD,
];
export const ACCOUNTING_MANAGE_ROLES = [
    ...ADMIN_ROLES,
    ROLE_ACCOUNTS_ADMIN,
    ROLE_ACCOUNTS_HEAD,
];

export const PLANNING_ACCESS_ROLES = [...ADMIN_ROLES, ROLE_PLANNER];
...
const MODULE_ROLE_MAP = {
    ...
    [MODULE_KEYS.ACCOUNTING]: ACCOUNTING_ACCESS_ROLES,
    [MODULE_KEYS.PLANNING]: PLANNING_ACCESS_ROLES,
    [MODULE_KEYS.HR]: [],
    [MODULE_KEYS.PAYROLL]: [],
};
