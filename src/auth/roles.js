...
export const INVENTORY_FINANCE_ROLES = [...ADMIN_ROLES, ROLE_SALES_ADMIN];
export const INVENTORY_VALUATION_ROLES = [
    ...ADMIN_ROLES,
    ROLE_INVENTORY_ADMIN,
    ROLE_SALES_ADMIN,
    ROLE_PURCHASE_ADMIN,
...
export const PURCHASE_MANAGE_ROLES = [...ADMIN_ROLES, ROLE_PURCHASE_ADMIN];

export const CONTACT_ACCESS_ROLES = [
    ...ADMIN_ROLES,
    ROLE_USER,
    ROLE_SALES_ADMIN,
    ROLE_SALES_USER,
...
const MODULE_ROLE_MAP = {
    ...
    [MODULE_KEYS.PURCHASE]: PURCHASE_ACCESS_ROLES,
    [MODULE_KEYS.CONTACT]: CONTACT_ACCESS_ROLES,
};
...
const ACTION_ROLE_MAP = {
    ...
    [ACTION_KEYS.INVENTORY_VALUATION_READ]: INVENTORY_VALUATION_ROLES,
    [ACTION_KEYS.PURCHASE_WRITE]: PURCHASE_MANAGE_ROLES,
    [ACTION_KEYS.WORK_ORDER_ADMIN_WRITE]: PRODUCTION_APPROVAL_ROLES,
    [ACTION_KEYS.ROUTING_LIFECYCLE_WRITE]: PRODUCTION_APPROVAL_ROLES,
    [ACTION_KEYS.BOM_STATUS_VERSION_WRITE]: PRODUCTION_APPROVAL_ROLES,
