...
const InventoryItemList = ({
  ...
  const handleEditClick = (id) => {
    ...
    const url = `${window.location.origin}${window.location.pathname}/edit/${id}`;
    ...
    <Box sx={{
      ...
      <Paper elevation={3} sx={{ padding: 2, maxWidth: "100%", margin: "auto", borderRadius: 2 }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", px: 1, pb: 1 }}>
          <Typography variant="h5" fontWeight={700} color="primary.main">Manage Products</Typography>
          <Box sx={{ position: 'relative', /* rest of styling above */ }}>
            ...
            <Button
              ...
              color="primary"
              variant="contained"
              sx={{ boxShadow: 3, borderRadius: 1, fontWeight: 200 }}
            >
              Add Product
            </Button>
            ...
            <TableBody>
              {inventoryItems?.map((item, index) => (
                ...
                >
                  ...
                  {/* Index */}
                  <TableCell align="center">{(index + 1) + (itemsPerPage) * currentPage}</TableCell>
